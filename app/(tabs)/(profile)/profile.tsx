...
// Define interfaces for the list items
interface LikedItem {
    id: number;
    imageUrl: string;
}
...
const exampleLikedShowsAndMovies: LikedItem[] = [
...
const exampleMyList: MyListItem[] = [
        ...
        <TabScreenWrapper isActive={isActive} slideDirection={slideDirection}>
            <View style={styles.container}>
                ...
                >
                    ...
                    {/* External Player menu item - now visible on all platforms */}
                    <TouchableOpacity
                        style={styles.menuItem}
                        onPress={() => router.push('/player-settings')}
                    >
                        <View style={styles.menuIconContainer}>
                            <View style={[styles.downloadIconContainer, { backgroundColor: '#4CAF50' }]}>
                                <Ionicons name="play-circle" size={24} color="#fff" />
                            </View>
                        </View>
                        <View style={styles.menuContent}>
                            <Text style={styles.menuText}>External Player</Text>
                            <Ionicons name="chevron-forward" size={20} color="#fff" />
                        </View>
                    </TouchableOpacity>
